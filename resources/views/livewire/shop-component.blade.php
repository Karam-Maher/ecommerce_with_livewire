                        ...
                        <div class="shop-product-fillter">
                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a href="#" class="{{ $orderBy=='Default Sorting' ? 'active': '' }}"
                                                    wire:click.prevent="changOrderBy('Default Sorting')">Default
                                                    Sorting</a></li>
                                            <li><a href="#" class="{{ $orderBy=='Price: Low to High' ? 'active': '' }}"
                                                    wire:click.prevent="changOrderBy('Price: Low to High')">Price: Low
                                                    to High</a></li>
                                            <li><a href="#" class="{{ $orderBy=='Price: High to Low' ? 'active': '' }}"
                                                    wire:click.prevent="changOrderBy('Price: High to Low')">Price: High
                                                    to Low</a></li>
                                            <li><a href="#" class="{{ $orderBy=='' ? 'active': 'Sort By Newness' }}"
                                                    wire:click.prevent="changOrderBy('Sort By Newness')">Sort By
                                                    Newness</a></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('product.details',['slug'=>$product->slug]) }}">
                                                <img class="default-img"
                                                    src="{{ asset('assets-front/imgs/shop/product-2-1.jpg') }}" alt="">
                                                <img class="hover-img"
                                                    src="{{ asset('assets-front/imgs/shop/product-2-2.jpg') }}" alt="">
                                            </a>
                                        </div>
