                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="{{ asset('assets-front/imgs/theme/flag-fr.png') }}"
                                                    alt="">Français</a></li>
                                        <li><a href="#"><img src="{{ asset('assets-front/imgs/theme/flag-dt.png') }}"
                                                    alt="">Deutsch</a></li>
                                        <li><a href="#"><img src="{{ asset('assets-front/imgs/theme/flag-ru.png') }}"
                                                    alt="">Pусский</a></li>
                                    </ul>
                                </li>
                            </ul>
                                            ...
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="{{ asset('assets-front/imgs/banner/menu-banner-2.jpg') }}"
                                                            alt="menu_banner1">
                                                    ...
                                                    <div class="header-banner2">
                                                        <img src="{{ asset('assets-front/imgs/banner/menu-banner-3.jpg') }}"
                                                            alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <h6>15% Off</h6>
                                                            <h4>Hot Deals</h4>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="{{ asset('assets-front/imgs/banner/menu-banner-4.jpg') }}"
                                                            alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="{{ asset('assets-front/imgs/banner/menu-banner-5.jpg') }}"
                                                            alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                                    ...
                                                    <div class="header-banner2">
                                                        <img src="{{ asset('assets-front/imgs/banner/menu-banner-6.jpg') }}"
                                                            alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <h6>15% Off</h6>
                                                            <h4>Hot Deals</h4>
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('assets-front/imgs/banner/menu-banner.jpg') }}"
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Surfside Media"
                                                        src="{{ asset('assets-front/imgs/shop/thumbnail-3.jpg') }}"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Surfside Media"
                                                        src="{{ asset('assets-front/imgs/shop/thumbnail-4.jpg') }}"></a>
                                            </div>
                                            <div class="shopping-cart-title">
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-social-icon">
                    ...
                    <a href="#"><img src="{{ asset('assets-front/imgs/theme/icons/icon-facebook.svg') }}" alt=""></a>
                    <a href="#"><img src="{{ asset('assets-front/imgs/theme/icons/icon-twitter.svg') }}" alt=""></a>
                    <a href="#"><img src="{{ asset('assets-front/imgs/theme/icons/icon-instagram.svg') }}" alt=""></a>
                    <a href="#"><img src="{{ asset('assets-front/imgs/theme/icons/icon-pinterest.svg') }}" alt=""></a>
                    <a href="#"><img src="{{ asset('assets-front/imgs/theme/icons/icon-youtube.svg') }}" alt=""></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            <div class="logo logo-width-1 wow fadeIn animated">
                                <a href="index.html"><img src="{{ asset('assets-front/imgs/logo/logo.png') }}"
                                        alt="logo"></a>
                            </div>
